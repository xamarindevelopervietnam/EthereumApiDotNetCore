...
namespace Lykke.Service.EthereumCore.Client
{
    ...
    public static partial class EthereumApiExtensions
    {
            ...
            /// <param name='model'>
            /// </param>
            public static EventResponse ApiCoinAdapterCreateCommonPost(this IEthereumApi operations, CreateAssetModel model = default(CreateAssetModel))
            {
                return operations.ApiCoinAdapterCreateCommonPostAsync(model).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<EventResponse> ApiCoinAdapterCreateCommonPostAsync(this IEthereumApi operations, CreateAssetModel model = default(CreateAssetModel), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.ApiCoinAdapterCreateCommonPostWithHttpMessagesAsync(model, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// <param name='model'>
            /// </param>
            public static EventResponse ApiCoinAdapterCreateErc20Post(this IEthereumApi operations, CreateCoinAdapterModelWithToken model = default(CreateCoinAdapterModelWithToken))
            {
                return operations.ApiCoinAdapterCreateErc20PostAsync(model).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<EventResponse> ApiCoinAdapterCreateErc20PostAsync(this IEthereumApi operations, CreateCoinAdapterModelWithToken model = default(CreateCoinAdapterModelWithToken), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.ApiCoinAdapterCreateErc20PostWithHttpMessagesAsync(model, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
